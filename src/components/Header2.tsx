...
const Header = () =>  {
    ...
    return (
        <div className={ "backdrop-blur-lg bg-white/85 z-20 sticky top-0 left-0 right-0 flex flex-row h-24 md:h-20 w-full border-b-0 shadow-xl items-center " }>
           <button  onClick={toggleMenu} className=" md:hidden absolute left-0 px-8 hover:opacity-75 z-20">
            ...
            <Link href="/" className={"w-40 h-24 md:h-20 hover:opacity-75 absolute top-1 px-4 pt-2 left-0 right-0 m-auto" }>
