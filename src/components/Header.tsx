...
import logoImage2 from '/public/icons/biglogo.png';
...
const Header = () =>  {
    ...
    return (
        <div className={header ? "backdrop-blur-lg bg-white/95 z-30 sticky top-0 left-0 right-0 flex flex-row h-28 md:h-20 w-full border-b-0 shadow-xl items-center md:mb-20" : "backdrop-blur-lg bg-white/95 z-30 sticky top-0 left-0 right-0 flex flex-row h-28 md:h-40 w-full border-b-0 shadow-xl items-center " }>
            ...
            <Link href="/" className={header ? "w-44 md:w-20 h-28 md:h-20 hover:opacity-75 absolute top-1 px-4 pt-2 left-0 right-0 m-auto" : "md:w-80 w-44 h-28 md:h-40 hover:opacity-75 absolute top-1 md:top-4 px-4 md:pt-0 pt-2 left-0 right-0 m-auto"}>
