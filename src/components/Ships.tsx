    ...
    return (
        ...
        <div className="grid w-full shadow-xl rounded-md items-center z-10 mt-2">
            <div className="grid grid-cols-8 grid rows-3 z-10">
                ...
                <p className="text-[8px] md:text-xs outline outline-1 md:outline-2 outline-white p-2 text-center" >08:30, 17:15</p>
                <p className="text-[8px] md:text-xs outline outline-1 md:outline-2 outline-white p-2 text-center">08:30, 17:00</p>
                <p className="text-[8px] md:text-xs outline outline-1 md:outline-2 outline-white p-2 text-center">08:30, 17:00</p>
                <p className="text-[8px] md:text-xs outline outline-1 md:outline-2 outline-white p-2 text-center">08:30, 17:00</p>
                <p className="text-[8px] md:text-xs outline outline-1 md:outline-2 outline-white p-2 text-center">08:30, 18:00</p>
                <p className="text-[8px] md:text-xs outline outline-1 md:outline-2 outline-white p-2 text-center">08:30, 12:00, 17:00</p>
                <p className="text-[8px] md:text-xs outline outline-1 md:outline-2 outline-white p-2 text-center">10:00, 18:00</p>
                ...
                <p className="text-[8px] md:text-xs outline outline-1 md:outline-2 outline-white p-2 text-center">06:45, 15:00</p>
                <p className="text-[8px] md:text-xs outline outline-1 md:outline-2 outline-white p-2 text-center">06:45, 15:30</p>
                <p className="text-[8px] md:text-xs outline outline-1 md:outline-2 outline-white p-2 text-center">06:45, 15:30</p>
                <p className="text-[8px] md:text-xs outline outline-1 md:outline-2 outline-white p-2 text-center">06:45, 15:30</p>
                <p className="text-[8px] md:text-xs outline outline-1 md:outline-2 outline-white p-2 text-center">06:45, 16:30</p>
                <p className="text-[8px] md:text-xs outline outline-1 md:outline-2 outline-white p-2 text-center">06:45, 10:00, 15:00</p>
                <p className="text-[8px] md:text-xs outline outline-1 md:outline-2 outline-white p-2 rounded-br-md text-center" >08:00, 16:30</p>
            </div>
        </div>
        <p className="text-sm font-semibold text-white text-center mt-2">Τηλ: 2224026200 & 2224029010</p>
