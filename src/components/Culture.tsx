...
export default async function  Shops()  {
    ...
    return (
        <div id='Places' className="animate-fadeInAnimation p-6 md:p-20 bg-gradient-to-r from-[#a0b29d] to-[#7ea9b5]  z-10 w-full md:pt-8 pb-40 overflow-hidden">
        <p className="text-4xl md:text-5xl text-white font-bold text-center mb-4 drop-shadow-md tracking-tight">Τοπική Κουλτούρα</p> 
            ...
            <span className="flex-grow h-px bg-white ml-4 mr-20"></span>
                ...
                <div className='grid grid-cols-1 md:grid-cols-3 gap-y-14 gap-x-0 pb-4'>
                    ...
                    <Link href={`/more/${beach.id}`} className="group hover:-translate-y-1 hover:scale-[1.01] transition ease-in-out duration-100 cursor-pointer m-8 m-w-20 w-full  decoration-green-900 border-radius-4 w-4/5 m-auto px-4 md:px-10">
                        ...
                        <button className="rounded-md md:rounded-sm border border-1 border-white relative  mx-auto my-2 flex items-center justify-center  px-5 py-2 overflow-hidden text-white transition duration-300 ease-out shadow-md hover: shadow-xl hover:ring-2 hover:[#7ea9b5]">
            ...
            <span className="flex-grow h-px bg-white ml-4 mr-20"></span>
                ...
                <div className='grid-cols-1 md:grid-cols-3 gap-y-14 gap-x-0 pb-4'>
